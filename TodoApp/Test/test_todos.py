...
def test_create_todo(test_todo):
    request_data = {
        "title": "Learn to test!",
        "description": "Practice testing with pytest",
        "priority": 2,
        "complete": False,
        "owner_id": 1
    }
    ...
    # assert response.json() == {"title": "Learn to test!", "description": "Practice testing with pytest", "priority": 2, "complete": False, "id": 2, "owner_id": 1}
